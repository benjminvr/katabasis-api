...
def chat_with_npc(user_id: str, npc_name: str, message: str):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": f"You are {npc_name}, a game NPC from hell. You must be mean and sarcastic."},
            *chat_history,
        ],
        max_tokens=150,
    ...
    redis_client.setex(redis_key, 1800, json.dumps(
        chat_history))  # Cache for 5 min
